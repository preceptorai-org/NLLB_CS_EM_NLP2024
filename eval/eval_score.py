...
if __name__ == "__main__":
    ...
    for model in tqdm(models_to_evaluate, desc="Evaluating Models", dynamic_ncols=True):
        model_bleu2_col = model + "_bleu2"
        model_bleu3_col = model + "_bleu3"
        model_bleu4_col = model + "_bleu4"
        model_chrf_col = model + "_chrf"
        model_meteor_col = model + "_meteor"
        model_wer_col = model + "_wer"
        model_cer_col = model + "_cer"
        model_cs_f1_col = model + "_cs_f1"
        model_cs_precision_col = model + "_cs_precision"
        model_cs_recall_col = model + "_cs_recall"
